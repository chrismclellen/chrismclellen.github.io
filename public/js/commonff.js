...
function HI_AVFrame(data) {
  ...
  if (this.pt === 49 || this.pt === 96 || this.pt === 100)
    //265
    this.u32AVFrameFlag = 0x46565848;
  else if (this.pt === 8 || this.pt === 97 || this.pt === 98)
    //8-G711,97-G726
  ...
  if (this.pt === 49) {
    ...
    if (this.payload[4] >> 1 === 32) this.u32AVFrameType = 1;
    else this.u32AVFrameType = 2;
  } else if (this.pt === 96) {
    if ((this.payload[4] & 0x1f) === 0x1) this.u32AVFrameType = 2;
    else this.u32AVFrameType = 1;
  } else if (this.pt === 100) {
